...
class AddKhatar extends StatefulWidget {
  const AddKhatar({super.key});

  @override
  State<AddKhatar> createState() => _AddKhatarState();
}

class _AddKhatarState extends State<AddKhatar> {
  ...
  void addBillToFirestore(
    ...
    try {
      await firestore.collection("Khatar").add({
        // 'id':widget.catId,
        'date': dateTime,
        'month':picked!.month,
        'year':picked!.year,
